...
def index(request):
    if request.method == 'POST':
        ...
        if file:
            ...
            # file_path = os.path.join(settings.MEDIA_ROOT, file_url[1:]).replace('/','\\')
            ...
            if image is not None:
                ...
                for c in cnts:
                    ...
                    if len(approx)==4:
                        ...
                        cv2.imwrite('C://Users//nithe//OneDrive//Desktop//kavach_django//lp_predictor'+str(i)+'.jpg',new_img)
                        i+=1
                        break
                ...
                Cropped_loc = 'C://Users//nithe//OneDrive//Desktop//kavach_django//7.jpg'
                ...
                return render(request,"C://Users//nithe//OneDrive//Desktop//kavach_django//lp_predictor//members//templates//result.html",context={'result':text,'img_url':file_url})
            else:
